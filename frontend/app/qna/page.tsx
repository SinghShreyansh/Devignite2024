...
const Summarize = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Notes Analyzer" description="" />
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div>
              <div>
                <div>
                  <div className="mx-auto w-[70rem] rounded-lg border bg-slate-200 p-2">
                    <div
                      className={`${
                      ...
                      <form onSubmit={handlePdfFileSubmit}>
                        <div className="mt-20 items-center">
                          <div className="flex flex-col place-items-center items-center justify-center space-y-2">
                            ...
                            <AiFillFolderOpen className="text-indigo h-8 w-8" />
                            <div>
                              <div
                                onClick={() => setIsList(!isList)}
                                className="text-indigo
                       flex cursor-pointer items-center justify-between rounded border p-4 text-sm font-medium leading-none hover:bg-gray-400"
                              >
                                {filename ? `${filename}` : `CHOOSE FILE`}
                                <div className="ml-2">
                                  {isList ? (
                                    <div>
                                      <MdArrowDropDown className="text-indigo" />
                                      {/* <svg
                              width={10}
                              height={6}
                              viewBox="0 0 10 6"
                            ...
                            {isList && (
                              <div className="dark:bg-#121416 mt-2 w-44 rounded border bg-[#f2f6fafb] p-2 shadow">
                                {/* <label> */}
                                ...
                                <label htmlFor="file-input">
                                  ...
                                  />
                                  <div className="my-1 w-full rounded-md border-gray-300 py-3 pl-9 text-sm font-medium leading-3 hover:bg-gray-400">
                                    From Device
                                  </div>
                                </label>
                                <button className="my-1 w-full rounded-md border border-gray-300 py-3 text-sm font-medium leading-3 hover:bg-gray-400">
                                  From Google Drive
                                </button>
                              </div>
                            )}
                            {pdfFile && !isList && (
                              <button
                                ...
                                type="button"
                                className="text-indigo mb-2 ml-4 mr-2 mt-5 w-[9rem] rounded-lg bg-gradient-to-br from-green-400 to-blue-600 px-5 py-2.5 text-center text-sm font-medium hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-green-200 dark:text-white dark:focus:ring-green-800"
                              >
                                Upload
                              </button>
                            )}
              ...
              {type === "qna" && filename && (
                <div className=" flex">
                  <div className="w-[50%] pl-16 pr-10 pt-20">
                  ...
                  <div className="w-[50%] pl-10 pr-20 pt-[5rem]">
            ...
            <label for="default-checkbox" class="ml-2 text-sm font-medium text-white">Ask Question from selected part of document ?</label>
                      ...
                      <>
                        ...
                        <div className="mb-5 rounded border">
                          <div className="m-3 bg-[#121416]">
                            <div className="max-h-[10rem] overflow-y-scroll bg-slate-800 p-7">
                              {selectedText
                                ? selectedText
                    ...
                    <div className="mb-3 flex justify-between p-3">
                      {!highlight && (
                        <div className="w-[92%] rounded border p-2">
                          <input
                            ...
                            className="h-[2.5rem] w-full bg-slate-200 p-3 "
                      ...
                      <button
                        ...
                        type="button"
                        className="text-indigo mb-2 mr-2 rounded-lg bg-gradient-to-br from-green-400 to-blue-600 px-7 py-2.5 text-center text-sm font-medium hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-green-200 dark:text-white dark:focus:ring-green-800"
                      >
                        Ask
                      </button>
                    </div>
