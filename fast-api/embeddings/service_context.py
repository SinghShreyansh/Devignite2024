...
os.environ["OPENAI_API_KEY"] = "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"
...
def get_service_context(embed="HF", llm="Openai"):
    ...
    llm_predictor =  LLMPredictor(llm=OpenAI(temperature=0, model_name="gpt-3.5-turbo-instruct", max_tokens=512)) if llm == "Openai" else LLMPredictor(llm=HuggingFaceHub(repo_id="google/flan-t5-xxl", model_kwargs={"temperature":0.4,"max_length":256}))
